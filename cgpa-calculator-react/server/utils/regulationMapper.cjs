...
function getRegulationForBatch(batchString) {
...
function getRegulationDisplayName(regulationYear) {
    if (!regulationYear) return null;
    return `${regulationYear}regulation`;
}

function getRegulationFullName(regulationYear) {
    if (!regulationYear) return null;
...
module.exports = {
    ...
    getRegulationDisplayName,
    getRegulationFullName
};
